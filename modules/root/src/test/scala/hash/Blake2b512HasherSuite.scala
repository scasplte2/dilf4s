...
import hash.Blake2b256HasherSuite.{expect, test}
...
import xyz.kd5ujc.hash.{Blake2b256Hasher, Blake2b512Hasher, l512}
...
object Blake2b512HasherSuite extends SimpleIOSuite with Checkers {
  ...
  test("Hasher.compare should return expected 512bit hash for fixed value") {
    for {
      ...
      expectedHash = l512.unsafe(Hex.decodeStrict("a2582130f8f37400f9a7da828d077f45c3d741d269116fedd2eb6305c340a858b3345cef09d31917149c6ff71b5b3ddc55cfcb1cfc46bd0b7cf509e8de18df9c"))
