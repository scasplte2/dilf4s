...
class SimpleMerklePatriciaProducer[F[_]: DigestProducer: MonadThrow] extends MerklePatriciaProducer[F] {
...
object SimpleMerklePatriciaProducer {
  def apply[F[_]: DigestProducer: MonadThrow]: SimpleMerklePatriciaProducer[F] =
